      ...
      <div class="modal-body">
        ...
        <div class="post-preview">
          <div class="feed-header">
            <div class="user-info">
              <img 
                :src="report.post.author?.avatar || '/src/assets/profile.png'" 
                alt="User Avatar" 
                class="avatar" 
              />
              <div>
                <div class="username">{{ report.post.author }}</div>
                <div class="timestamp">{{ formatTimestamp(report.post.date) }}</div>
              </div>
            </div>
          ...
          <div class="post-stats">
            ...
            <div class="stat-item">
              ...
              <span class="stat-count">{{ report.post.comments || 0 }} komentar</span>
            </div>
            <div class="stat-item">
              <span class="stat-icon">🔗</span>
              <span class="stat-count">{{ report.post.shares || 0 }} bagikan</span>
            </div>
          </div>
        </div>
        ...
        <div class="report-section">
          ...
          <div class="report-info">
            ...
            <div class="report-item">
              ...
              <span class="value">{{ formatTimestamp(report.reportDate) }}</span>
            </div>
        ...
        <div v-if="relatedReports.length > 0" class="related-reports">
          ...
          <div class="related-list">
            ...
            >
              ...
              <div class="related-reason">{{ getCategoryLabel(relatedReport.category) }}</div>
              <div class="related-date">{{ formatTimestamp(relatedReport.reportDate) }}</div>
            </div>
          </div>
        </div>
...
.reason-tag.spam, .reason-tag.other {
  background: rgba(255, 184, 0, 0.2);
  color: #ffb800;
}

.reason-tag.inappropriate, .reason-tag.harassment {
  background: rgba(255, 71, 87, 0.2);
  color: #ff4757;
}
