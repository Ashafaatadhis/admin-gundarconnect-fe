      ...
      >
        ...
        <div class="post-content">
          ...
          <div v-if="report.post.image" class="post-image">
            <img :src="report.post.image" alt="Post image" />
          </div>
        </div>
        ...
        <div class="report-details">
          ...
          <div class="report-reason">
            ...
            <span class="reason-tag" :class="report.category">{{ getCategoryLabel(report.category) }}</span>
          </div>
...
export default {
  ...
  setup() {
    ...
    const reports = ref([
      ...
      },
      {
        ...
        post: {
          id: 502,
          author: 'Jane Smith',
          content: 'Promo special discount 90%! Link di bio! Buruan sebelum kehabisan! #promo #discount #sale',
      ...
      },
      {
        ...
        post: {
          id: 503,
          author: 'Bad User',
          content: 'Kamu jelek banget deh, mending ga usah posting foto. Dasar orang ga punya cermin.',
      ...
      },
      {
        ...
        post: {
          id: 504,
          author: 'Fake News',
          content: 'Breaking news: Alien mendarat di Jakarta kemarin malam! Sumber terpercaya mengatakan mereka datang dengan damai.',
      ...
      },
      {
        ...
        post: {
          id: 505,
          author: 'Random User',
          content: 'Post yang melanggar aturan komunitas dengan cara lain yang tidak termasuk kategori di atas. Konten ini mengandung hal-hal yang tidak sesuai.',
      ...
      },
      {
        ...
        post: {
          id: 506,
          author: 'User123',
          content: 'Posting gambar dan konten yang tidak pantas untuk platform ini. Harusnya ada age restriction.',
    ...
    const markAsReview = (report) => {
      const index = reports.value.findIndex(r => r.id === report.id)
      if (index !== -1) {
        reports.value[index].status = 'review'
      }
    }
...
.reporter-info, .report-reason, .report-description {
  display: flex;
...
.reporter-name, .description-text {
  color: #00f2fe;
  font-weight: 500;
}
