    ...
    <div class="login-box">
      ...
      <div class="login-header">
        <div class="logo-section">
          ...
          <h1 class="app-name">GundarConnect</h1>
        </div>
  ...
  setup(props, { emit }) {
    ...
    const handleLogin = async () => {
      ...
      try {
        ...
        // Demo credentials - ganti dengan validasi real
        if (loginForm.email === 'admin@gundarconnect.com' && loginForm.password === 'admin123') {
          // Set authentication status
          localStorage.setItem('isAuthenticated', 'true')
          localStorage.setItem('adminEmail', loginForm.email)
          ...
          // Force redirect ke dashboard admin
...
.floating-shape {
  position: absolute;
  background: linear-gradient(135deg, rgba(56, 178, 172, 0.1), rgba(79, 209, 197, 0.1));
  border-radius: 50%;
