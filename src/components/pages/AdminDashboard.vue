...
export default {
  ...
  setup() {
    ...
    // Get admin name from localStorage or userEmail
    const adminName = ref(
    ...
    const recentActivities = ref([
      {
        id: 1,
        user: 'David Radot',
        text: 'Posted a new update about cooking',
        time: '2 minutes ago',
        type: 'post',
        typeLabel: 'Post'
      },
      {
        id: 2,
        user: 'Sarah Johnson',
        text: 'Reported inappropriate content',
        time: '5 minutes ago',
        type: 'report',
        typeLabel: 'Report'
      },
      ...
      },
      {
        id: 4,
        user: 'Lisa Wong',
        text: 'Commented on trending post',
        time: '15 minutes ago',
        type: 'comment',
        typeLabel: 'Comment'
      }
    ...
    onMounted(() => {
      ...
      // Update admin name jika ada di localStorage
      const storedEmail = localStorage.getItem('adminEmail')
      if (storedEmail) {
        adminName.value = storedEmail.split('@')[0]
      }
    })
